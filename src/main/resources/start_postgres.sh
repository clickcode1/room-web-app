...
docker cp ./src/main/resources/schema.sql pg-docker:/docker-entrypoint-initdb.d/schema.sql
docker cp ./src/main/resources/data.sql pg-docker:/docker-entrypoint-initdb.d/data.sql
